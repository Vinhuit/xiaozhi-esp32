...
void ui_Weather_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Pary_Cloud, -5);
    lv_obj_set_y(ui_Pary_Cloud, -49);
    ...
    lv_obj_set_style_text_font(ui_Pary_Cloud, &ui_font_Font1, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_New_York = ui_Small_Label_create(ui_Weather);
    lv_obj_set_x(ui_New_York, -8);
    lv_obj_set_y(ui_New_York, -25);
    ...
    lv_obj_set_style_text_font(ui_New_York, &ui_font_Font1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Cloud, -11);
    lv_obj_set_y(ui_Cloud, 3);
    ...
    lv_obj_set_x(ui_Celsius, 7);
    lv_obj_set_y(ui_Celsius, 115);
    ...
    lv_obj_set_y(ui_Weather_Icons, -16);
