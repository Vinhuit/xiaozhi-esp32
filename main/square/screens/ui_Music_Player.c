...
void ui_Music_Player_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Music_Title, 2);
    lv_obj_set_y(ui_Music_Title, 12);
    ...
    lv_obj_set_style_text_font(ui_Music_Title, &ui_font_Font1, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Author = ui_Small_Label_create(ui_Music_Player);
    lv_obj_set_x(ui_Author, -1);
    lv_obj_set_y(ui_Author, -5);
    ...
    lv_obj_set_style_text_font(ui_Author, &ui_font_Font1, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Play_btn = lv_obj_create(ui_Music_Player);
    lv_obj_set_width(ui_Play_btn, 60);
    lv_obj_set_height(ui_Play_btn, 60);
    lv_obj_set_x(ui_Play_btn, -1);
    lv_obj_set_y(ui_Play_btn, -33);
