...
lv_obj_t * ui_batterylow = NULL;
lv_obj_t * ui_batteryhaft = NULL;
lv_obj_t * ui_batterycharging = NULL;
...
void ui_Clock_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Clock_Panel, 181);
    lv_obj_set_height(ui_Clock_Panel, 134);
    lv_obj_set_x(ui_Clock_Panel, -4);
    lv_obj_set_y(ui_Clock_Panel, 38);
    ...
    lv_obj_set_x(ui_Clock_Number, -4);
    lv_obj_set_y(ui_Clock_Number, 14);
    ...
    lv_obj_set_x(ui_Date, -3);
    lv_obj_set_y(ui_Date, 67);
    ...
    ui_wifistatus = ui_Small_Label_create(ui_Clock);
    lv_obj_set_align(ui_wifistatus, LV_ALIGN_TOP_LEFT);
    lv_obj_set_x(ui_wifistatus, 15);
    lv_obj_set_y(ui_wifistatus, 21);

    ui_battery = ui_Small_Label_create(ui_Clock);
    lv_obj_set_align(ui_battery, LV_ALIGN_TOP_RIGHT);
    lv_obj_set_x(ui_battery, -15);
    lv_obj_set_y(ui_battery, 15);
