...
void ui_add_chat_message(const char *text, bool is_user) {
    ...
    if (is_user) {
        ...
        lv_obj_set_style_bg_color(bubble, lv_color_hex(0x293062), 0);
    } else {
        lv_obj_set_align(bubble, LV_ALIGN_TOP_LEFT);
        lv_obj_set_style_bg_color(bubble, lv_color_hex(0x9C9CD9), 0);
    }
    ...
    lv_obj_scroll_to_view_recursive(msg_container, LV_ANIM_ON);  // or LV_ANIM_OFF
}
